...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-[#1A1A1A] text-white group/calendar p-4 [--cell-size:2.5rem] border border-white/10 shadow-xl",
      ...
      classNames={{
        ...
        today: cn(
          "bg-[#C8A45D]/20 text-[#C8A45D] rounded-md data-[selected=true]:rounded-none",
        ...
        disabled: cn(
          "text-white/20 opacity-40 line-through",
